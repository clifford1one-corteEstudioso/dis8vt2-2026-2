...
"A hook is the first thing that catches your audience's eye (Liz Willitz). Hooks should captivate, grab attention, and be unique."

Cuando una personas está scrolleando, el comportamiento predeterminado no es el de ver, y scrollear cuando el contenido no llama tu atención. Al contrario, el comportamiento predeterminado es el seguir scrolleando, y detenerse cuando algo llama tu atención. Por eso los ganchos son tan importantes, porque por defecto, la persona seguirá scrolleando, a menos que se logre cautivarlo, y con ello retenerlo. Es un comportamiento común pasarte una publicación, y uno segundos después volver a ella.

Una de las cosas más importantes de un *hook*, es generar la sensación conocida como *curiosity gap*.

- If you can't capture your audience's attention right away, you've lost them(Joseph Sugarman)

Para retener a un usuario debes:

1. value exchange
2. generar una emoción

#### hooks en diferentes medios

- Website headline or hero image
- First line (or first few lines) of copy
- Video thumbnail
- First few seconds of dialogue in a video
- Instagram image(preview o portada de la publicación)

#### tipos de hooks

- apelar al miedo y a su resolución
- ideas contradictorias
- datos cuantitativos

#### partes que componen a un *hook*

1. setup: un escenario de algo que sea importante para tu **target audience**, y que les haga preveer de alguna manera que es lo que está por venir. **Plantear una pregunta en la mente de los espectadores**

#### ejemplos de hooks

- *this cofee should NOT taste good...*
- *lean at 45 - and i eats carbs every day*
- *the reason your tiktoks are flopping, is happening within the first 2 seconds*
- *the exact morning routine, that fixed my dogs anxiety in only 7 days*

## referencias

- [Content Marketing Institute](https://contentmarketinginstitute.com/)
- [Content Marketing Institute - Hooks](https://contentmarketinginstitute.com/audience-building/how-to-catch-audiences-with-extraordinary-hooks)
- ["I Studied 1,000 Hooks, Here’s How to ACTUALLY Go Viral" - heyDominik](https://youtu.be/Xqy9L-88wcw)
- [CopyHackers - Curiosity Gap](https://copyhackers.com/2014/04/curiosity-gap/)