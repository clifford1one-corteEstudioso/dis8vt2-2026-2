...
fun Pantalla(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Text("LYS Fase 02a", style = MaterialTheme.typography.titleLarge)
        Text(
            "Guarda todo a un .txt. Puedes usar el celular desconectado del PC.",
        ...
        Text(
            "Activa ahi \"LYS Fase 02a — guardar a archivo\", vuelve, y usa Instagram normal.",
